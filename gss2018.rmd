...
```
 ...
 This graph shows that  people who own a gun shows that are more likely to favor capital punishment
...
```
 ...
 This shows that depending on the degree of school high-schools have a better percentage then other degrees on their test  
...
#### Question 1: is gun ownership inepedent of the opinion on capial punishment. the summary results and the inferential results show tat they are not imdependent 
